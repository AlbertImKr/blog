...
3. 프론트엔드와 백엔드 작업의 병행
    - 혼자서 백엔드와 프론트엔드를 모두 작업하다 보니 불편함을 느꼈습니다. 백엔드에서 JSON을 보내면 프론트엔드에서는 쉽게 처리할 수 있지만 템플릿 작업에 신경을 쓰다 보니 많은 불필요한 시간과 노력을
      투자하게 되었습니다. 프론트엔드와 백엔드를 분리하여 작업하거나 각 분야의 전문가와 협력하는 것이 더 효율적일 것이라는 것을 느꼈습니다.
